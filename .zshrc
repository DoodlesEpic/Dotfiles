...
plugins=(git zsh-autosuggestions zsh-history-substring-search zsh-syntax-highlighting cabal colored-man-pages common-aliases dnf git-auto-fetch heroku node npm nvm pip pipenv poetry python rsync rust safe-paste systemadmin systemd vscode yum)
